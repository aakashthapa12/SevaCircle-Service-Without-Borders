...
let AuthService = class AuthService {
    ...
    async createWorker(email, password, name, phone) {
    ...
    async getProfileFromToken(token) {
        ...
        if (decoded.role === 'worker') {
            ...
            if (!worker)
                throw new common_1.UnauthorizedException('Worker not found');
            return { role: 'worker', profile: worker };
        }
        throw new common_1.UnauthorizedException('Unsupported role');
    }
